...
$conn = require_once __DIR__ . '/../../module/db.config.php';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($token === '' || $pass1 === '' || $pass2 === '') {
        ...
        $stmt = $conn->prepare("
            SELECT user_id, token_expiration FROM user
        ...
        if ($row === null) {
            ...
            $msgType = 'danger';
        } elseif (strtotime($row['token_expiration']) <= time()) {
...
<head>
    ...
    <title>Perinatal Care - Reset Password Trial</title>
                ...
                <div class="login-card-container">
                    ...
                    <form method="post" class="needs-validation" novalidate>
                        ...
                        <div class="form-floating mb-3 position-relative">
                            ...
                            <i class="bi bi-eye-fill fa-lg text-secondary position-absolute top-50 end-0 translate-middle-y me-3"
                                id="eyeIcon2" style="cursor: pointer;"></i>
                            <div class="invalid-feedback">Please confirm your password.</div>
                        </div>

                        <ul class="password-requirements mb-3">
                            <li><i class="fas fa-check-circle text-muted me-1"></i> At least 8 characters long</li>
