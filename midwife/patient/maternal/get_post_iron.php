...
$query = "SELECT post_supp_id, iron_folic_month_given, iron_folic_date_given, tablets_given FROM post_partum_supp
          WHERE pregnancy_id = ? ORDER BY iron_folic_month_given ASC";
