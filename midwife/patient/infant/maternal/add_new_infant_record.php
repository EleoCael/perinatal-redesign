...
$query = "SELECT * FROM patient WHERE patient_id = ? AND patient_type = 'mother'";
...
$mother_full_name = '';
$mother_address = '';
$mother_family_serial = '';
$mother_socio_economic = '';
$mother_contact = '';

if ($mother) {
    $mother_full_name = htmlspecialchars($mother['last_name'], ENT_QUOTES, 'UTF-8') . ", " .
        htmlspecialchars($mother['first_name'], ENT_QUOTES, 'UTF-8');
    if (!empty($mother['middle_name'])) {
        $mother_full_name .= " " . htmlspecialchars($mother['middle_name'], ENT_QUOTES, 'UTF-8');
    }

    $mother_address = htmlspecialchars($mother['address'] ?? '', ENT_QUOTES, 'UTF-8');
    $mother_family_serial = htmlspecialchars($mother['family_serial_number'] ?? '', ENT_QUOTES, 'UTF-8');
    $mother_socio_economic = htmlspecialchars($mother['socio_economic_status'] ?? '', ENT_QUOTES, 'UTF-8');
    $mother_contact = htmlspecialchars($mother['contact_number'] ?? '', ENT_QUOTES, 'UTF-8');
}
?>.

<div class="main-container">
    <form action="/rhusystem/midwife/patient/maternal/save_new_infant_record.php" method="POST">
        <ul class="nav nav-tabs" id="myTabs">
            <li class="nav-item">
                <a class="nav-link active" data-bs-toggle="tab" href="#patient-details-tab">Patient Details</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="#newborn-screening-tab">Newborn Screening</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="#postpartum-care-tab">Nutrient Supplementation</a>
            </li>
        </ul>

        <div class="tab-content content-main-div">
          
            <input type="hidden" name="mother_id" id="mother_id" value="<?= htmlspecialchars($_GET['mother_id'] ?? '') ?>">
            <div class="alert alert-info">
                Adding infant record for: <strong><?= htmlspecialchars($mother['last_name'] . ', ' . $mother['first_name']) ?></strong>
            </div>
                        ...
                        <div class="form-group group-form">
                            ...
                            <div class="row g-3">
                                <div class="col mt-4">
                                    ...
                                    <input type="date" class="form-control" name="date_of_registration" max="<?php echo date('Y-m-d'); ?>">
                                </div>
                                <div class="col mt-4">
                                ...
                                <div class="col dropdown mt-4">
                                    ...
                                    <select class="form-select" name="socio_economic_status" disabled style="background-color: #f8f9fa; cursor: not-allowed;">
                                        <option value="" disabled selected>Select Status</option>
                                        <option value="1 - NHTS" <?= $mother_socio_economic == '1 - NHTS' ? 'selected' : '' ?>>1-NHTS</option>
                                        <option value="2 - Non-NHTS" <?= $mother_socio_economic == '2 - Non-NHTS' ? 'selected' : '' ?>>2-Non-NHTS</option>
                                    </select>
                                    <input type="hidden" name="socio_economic_status" value="<?= $mother_socio_economic ?>">
                            ...
                            <div class="row g-3">
                                <div class="col">
                                    ...
                                    <input type="date" class="form-control" name="infant_birth_date" max="<?php echo date('Y-m-d'); ?>">
                                </div>
                                <div class="col">
                                    <label class="form-label">Contact Number<span class="text-danger">*</span></label><br>
                                    <input type="tel" class="form-control" placeholder="ex. 09123456789" name="contact_number"
            ...
            <div class="tab-pane fade" id="newborn-screening-tab">
                ...
                <div class="d-flex justify-content-end gap-2 mb-3 ">
                    ...
                    <button class="btn btn-primary js-next_button col-md-2" type="button">Next</button>
                </div>
            </div>
            <!--Newborn Screening-->
