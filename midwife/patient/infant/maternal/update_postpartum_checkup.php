...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$checkup_id || !$pregnancy_id || !$checkup_visit || !$post_checkup_date) {
        echo json_encode(["success" => false, "message" => "All fields are required"]);
        exit;
    }

    $update_query = "UPDATE post_partum_checkup SET checkup_visit = ?, post_checkup_date = ? WHERE checkup_id = ? AND pregnancy_id = ?";
    ...
    $stmt->bind_param("ssii", $checkup_visit, $post_checkup_date, $checkup_id, $pregnancy_id);
