...
$post_query = "SELECT post_delivery_date, post_delivery_time, breastfeeding_date, breastfeeding_time FROM post_partum_checkup WHERE patient_id  = ?";
$stmt_post_query = $conn->prepare($post_query);
$stmt_post_query->bind_param("i", $patient_id);
