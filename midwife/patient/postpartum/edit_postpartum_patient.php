...
<div class="container-fluid py-4">
    <div class="row g-0 border border-secondary-subtle rounded bg-white">
            ...
            <div class="d-flex flex-column h-100">
                <div class="mb-4 ps-2">
                    ...
                    <h5 class="text-dark fw-bold mb-0">
                        <?=htmlspecialchars(($patient['first_name'] ?? '') . ' ' . ($patient['last_name'] ?? '')) ?: 'Postpartum Patient'?>
                    </h5>
                    <small class="text-secondary font-monospace">ID: <?=htmlspecialchars($patient['patient_id'] ?? 'N/A')?></small>
                </div>
                
              
                <div class="nav flex-column nav-pills gap-1" id="postpartumFormTabs" role="tablist" aria-orientation="vertical">
        ...
        <div class="col-md-9 d-flex flex-column">
            <form id="editPostpartumForm" method="POST" class="d-flex flex-column justify-content-between h-100 mb-0">
                <input type="hidden" name="patient_id" value="<?=htmlspecialchars($patient['patient_id'] ?? '')?>">
                
                <div class="card-body p-4 tab-content" id="postpartumFormContent">
                ...
                <div class="d-flex justify-content-end gap-2 p-3 bg-light border-top mt-auto">
                    <button type="button" class="btn btn-sm btn-outline-secondary px-4 fw-medium" onclick="loadPage('patient/postpartum/view_postpartum_record.php');">Back</button>
...
#postpartumFormTabs .nav-link {
    color: var(--bs-secondary);
    border: 1px solid transparent;
}
#postpartumFormTabs .nav-link.active {
