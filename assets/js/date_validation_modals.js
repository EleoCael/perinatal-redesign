...
function validateDateDoneInput() {
    ...
    if (!input) return true; // Return true if element doesn't exist
    ...
    if (selectedDate > today) {
        if (errorSpan) errorSpan.textContent = 'Date Done cannot be in the future!';
...
function validateReferralDateInput() {
    ...
    if (selectedDate > today) {
        if (errorSpan) errorSpan.textContent = 'Referral date cannot be in the future!';
        input.classList.add('is-invalid');
        return false;
    } else {
        if (errorSpan) errorSpan.textContent = '';
...
function validateAssessedDateInput() {
    ...
    if (selectedDate > today) {
        if (errorSpan) errorSpan.textContent = 'Date Assessed cannot be in the future!';
        input.classList.add('is-invalid');
        return false;
    } else {
        if (errorSpan) errorSpan.textContent = '';
...
function validateBcgDateInput() {
    ...
    if (selectedDate > today) {
        if (errorSpan) errorSpan.textContent = 'BCG Date cannot be in the future!';
        input.classList.add('is-invalid');
        return false;
    } else {
        if (errorSpan) errorSpan.textContent = '';
...
function validateHepaBDateInput() {
    ...
    if (selectedDate > today) {
        if (errorSpan) errorSpan.textContent = 'Hepa B1 Date cannot be in the future!';
        input.classList.add('is-invalid');
        return false;
    } else {
        if (errorSpan) errorSpan.textContent = '';
...
function validatePentavalentDateInput() {
    ...
    if (selectedDate > today) {
        if (errorSpan) errorSpan.textContent = 'Pentavalent Date cannot be in the future!';
        input.classList.add('is-invalid');
        return false;
    } else {
        if (errorSpan) errorSpan.textContent = '';
...
function validateOpvDateInput() {
    ...
    if (selectedDate > today) {
        if (errorSpan) errorSpan.textContent = 'OPV Date cannot be in the future!';
        input.classList.add('is-invalid');
        return false;
    } else {
        if (errorSpan) errorSpan.textContent = '';
...
function validateIpvDateInput() {
    ...
    if (selectedDate > today) {
        if (errorSpan) errorSpan.textContent = 'IPV Date cannot be in the future!';
        input.classList.add('is-invalid');
        return false;
    } else {
        if (errorSpan) errorSpan.textContent = '';
...
function validateMcvDateInput() {
    ...
    if (selectedDate > today) {
        if (errorSpan) errorSpan.textContent = 'MCV Date cannot be in the future!';
        input.classList.add('is-invalid');
        return false;
    } else {
        if (errorSpan) errorSpan.textContent = '';
...
function validateFicDateInput() {
    ...
    if (selectedDate > today) {
        if (errorSpan) errorSpan.textContent = 'FIC Date cannot be in the future!';
        input.classList.add('is-invalid');
        return false;
    } else {
        if (errorSpan) errorSpan.textContent = '';
...
function validateRvvDateInput() {
    ...
    if (selectedDate > today) {
        if (errorSpan) errorSpan.textContent = 'RVV Date cannot be in the future!';
        input.classList.add('is-invalid');
        return false;
    } else {
        if (errorSpan) errorSpan.textContent = '';
...
function validatePcvDateInput() {
    ...
    if (selectedDate > today) {
        if (errorSpan) errorSpan.textContent = 'PCV Date cannot be in the future!';
        input.classList.add('is-invalid');
        return false;
    } else {
        if (errorSpan) errorSpan.textContent = '';
...
function validateVitaminDateInput() {
    ...
    if (selectedDate > today) {
        if (errorSpan) errorSpan.textContent = 'Vitamin A Date cannot be in the future!';
        input.classList.add('is-invalid');
        return false;
    } else {
        if (errorSpan) errorSpan.textContent = '';
...
function validateIronDateInput() {
    ...
    if (selectedDate > today) {
        if (errorSpan) errorSpan.textContent = 'Iron Date cannot be in the future!';
        input.classList.add('is-invalid');
        return false;
    } else {
        if (errorSpan) errorSpan.textContent = '';
...
function validateMnpDateInput() {
    ...
    if (selectedDate > today) {
        if (errorSpan) errorSpan.textContent = 'MNP Date cannot be in the future!';
        input.classList.add('is-invalid');
        return false;
    } else {
        if (errorSpan) errorSpan.textContent = '';
...
function validateDewormingDateInput() {
    ...
    if (selectedDate > today) {
        if (errorSpan) errorSpan.textContent = 'Deworming Date cannot be in the future!';
        input.classList.add('is-invalid');
        return false;
    } else {
        if (errorSpan) errorSpan.textContent = '';
...
function validateAllDates() {
    ...
    const assessedDateValid = validateAssessedDateInput();
    ...
    return referralDateValid && dateDoneValid && cpabDateValid && assessedDateValid && bcgDateValid && hepaBDateValid
